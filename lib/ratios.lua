...
ratiointervals.list = {
  ...
  [15/14] = {"A1","A1","A1^5_7"}, -- augmented unison
  [13/12] = {"t2","m2","m2^13"}, -- tridecimal neutral second, tridecimal 2
  [12/11] = {"N2","M2","M2_11"}, -- undecimal neutral second, (lesser) neutral second
  ...
  [18/11] = {"n6","M6","M6_11"}, -- undecimal neutral sixth
