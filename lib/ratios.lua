...
ratiointervals.list = {
  ...
  [ 7/5 ] = {"TT","d5","d5^7_5"}, -- lesser septimal tritone TT, sub-fifth, Huygens' tritone
  [45/32] = {"A4","A4","A4^5"}, -- just augmented fourth, diatonic tritone
  [17/12] = {"d5","d5","d5^17"}, --  larger septendecimal tritone
  [10/7 ] = {"S4","A4","A4^5_7"}, -- greater septimal tritone, super-fourth, Euler's tritone, superaugmented fourth
