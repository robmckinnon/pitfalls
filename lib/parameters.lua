...
function parameters.init()
  ...
  params:add_number("s", "s", 1)
  params:add_number("tuning", "tuning", 400, 480, 440)
  params:add_number("tonic", "tonic", 1)
  params:add_number("mode", "mode", 1)
  ...
  params:add_control("tempo_div", "tempo_div", controlspec.new(0.25, 64, 'lin', 0.25, 8, 'd'))
